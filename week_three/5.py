...
a = input("¡Juguemos! Ingresá piedra ( R), papel (P) o tijera (T): ")

resultados = ["R", "P", "T", "r", "t", "p"]

def juego():
    if a in resultados:
        if a == "R":
            print("Papel!, Perdiste, intentalo de nuevo!")
        elif a == "P":
            print("Tijera!, Perdiste, intentalo de nuevo!")
        else:
            print("Piedra!, Perdiste, intentalo de nuevo")
    else: 
        print("No vale esa letra!")
juego()